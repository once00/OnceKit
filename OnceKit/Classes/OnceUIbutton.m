...
@implementation OnceUIbutton

+ (id)buttonWithType:(UIButtonType)buttonType withSpace:(CGFloat)space {
    OnceUIbutton *button = [super buttonWithType:buttonType];
    button.space = space;
    return button;
}
